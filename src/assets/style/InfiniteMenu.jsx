        ...
        <>
          ...
          <h2
            className={`
              ...
              max-w-[30ch] sm:max-w-[25ch] md:max-w-[20ch] lg:max-w-[18ch]
              leading-tight
          ...
          <p
            className={`
              ...
              top-1/2 right-2 sm:right-4 md:right-6 lg:right-8
              max-w-[25ch] sm:max-w-[20ch] md:max-w-[18ch] lg:max-w-[15ch]
              leading-snug text-right
              transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
              ${
                isMoving
                  ? "opacity-0 pointer-events-none duration-[100ms] -translate-y-1/2 translate-x-[10px]"
                  : "opacity-100 pointer-events-auto duration-[500ms] -translate-y-1/2 translate-x-0"
              }
            `}
          >
