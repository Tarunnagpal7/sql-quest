export const items = [
  {
    image: '/image1.webp', // Gemini prompt: "A poor but clever young boy reading scrolls under a giant tree in a dusty village, golden sunset, books and maps scattered around"
  ...
  {
    image: '/image2.webp', // Prompt: "An ancient glowing treasure map on a wooden desk surrounded by candles and dusty books, symbols floating above it"
  ...
  {
    image: '/image3.webp', // Prompt: "A young boy standing before a dark jungle with glowing blue runes and mist, holding a scroll in hand"
  ...
  {
    image: '/image4.webp', // Prompt: "Inside an ancient temple with stone pillars and glowing walls full of encrypted SQL code, eerie light all around"
  ...
  {
    image: '/image6.webp', // Prompt: "A giant door with glowing lock made of databases and code symbols, a puzzle projected in mid-air before it"
    title: 'Gate of Joins',
  ...
  {
    image: '/image7.webp', // Prompt: "A hidden underground chamber with golden light, treasure chests, and glowing scrolls — symbols of wisdom and power"
