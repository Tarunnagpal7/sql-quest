...
function FeatureScroll({ onStackComplete, stackComplete }) {
  return (
    <div
      className="relative h-screen snap-start flex items-center justify-center overflow-hidden p-6 md:p-12"
      style={{
        ...
        >
          <ScrollStackItem>
            <div className="bg-gradient-to-br from-slate-900/90 to-gray-800/90 backdrop-blur-xl border-2 border-cyan-400/60 rounded-xl p-4 shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-cyan-400/30 hover:border-cyan-300/80 group">
              <div className="text-cyan-300 text-4xl mb-6 group-hover:scale-110 transition-transform duration-300">
                ⚔️
              </div>
              <h3 className="text-2xl font-bold text-cyan-100 mb-4 tracking-wide group-hover:text-cyan-200 transition-colors">
                Epic Quests
              </h3>
              <p className="text-gray-200/90 text-lg leading-relaxed group-hover:text-gray-100 transition-colors">
                Embark on challenging SQL adventures through mystical realms
                filled with ancient mysteries
              </p>
          ...
          <ScrollStackItem>
            <div className="bg-gradient-to-br from-amber-900/90 to-orange-800/90 backdrop-blur-xl border-2 border-amber-400/60 rounded-xl p-4 shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-amber-400/30 hover:border-amber-300/80 group">
              <div className="text-amber-300 text-4xl mb-6 group-hover:scale-110 transition-transform duration-300">
                🎯
              </div>
              <h3 className="text-2xl font-bold text-amber-100 mb-4 tracking-wide group-hover:text-amber-200 transition-colors">
                Skill Mastery
              </h3>
              <p className="text-gray-200/90 text-lg leading-relaxed group-hover:text-gray-100 transition-colors">
                Level up your database knowledge with ancient wisdom passed down
                through generations
              </p>
          ...
          <ScrollStackItem>
            <div className="bg-gradient-to-br from-purple-900/90 to-indigo-800/90 backdrop-blur-xl border-2 border-purple-400/60 rounded-xl p-4 shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-purple-400/30 hover:border-purple-300/80 group">
              <div className="text-purple-300 text-4xl mb-6 group-hover:scale-110 transition-transform duration-300">
                📖
              </div>
              <h3 className="text-2xl font-bold text-purple-100 mb-4 tracking-wide group-hover:text-purple-200 transition-colors">
                Rich Story
              </h3>
              <p className="text-gray-200/90 text-lg leading-relaxed group-hover:text-gray-100 transition-colors">
                Learn through immersive narratives and dragon lore spanning
                countless ages
              </p>
